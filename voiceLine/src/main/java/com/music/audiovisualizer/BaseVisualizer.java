...
*/
package com.music.audiovisualizer;
...
import com.music.audiovisualizer.model.PaintStyle;
        ...
        if (typedArray != null && typedArray.length() > 0) {
            try {
                ...
                if (paintType != null && !paintType.equals(""))
                    this.mPaintStyle = paintType.equals("outline") ? PaintStyle.OUTLINE : PaintStyle.FILL;

                String gravityType = typedArray.getString(R.styleable.BaseVisualizer_avGravity);
                if (gravityType != null && !gravityType.equals(""))
                    this.mPositionGravity = gravityType.equals("top") ? PositionGravity.TOP : PositionGravity.BOTTOM;

                int speedType = typedArray.getInteger(R.styleable.BaseVisualizer_avSpeed, 0);
                switch (speedType) {
                    case 0:
