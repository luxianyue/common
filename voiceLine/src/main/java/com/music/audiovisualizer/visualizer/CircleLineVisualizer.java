...
public class CircleLineVisualizer extends BaseVisualizer {
    ...
    public CircleLineVisualizer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleLineVisualizer(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        LinearGradient lg = new LinearGradient(getWidth() / 2f + mRadius, getHeight() / 2f, getWidth() / 2f + mRadius + mPointRadius * 5, getHeight() / 2f
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 360; i = i + 360 / mPoints) {
            ...
            canvas.save();
            canvas.rotate(-i, getWidth() / 2f, getHeight() / 2f);
