 ...
 */
public class HttpUrlSource_bat implements Source {
    ...
    public HttpUrlSource_bat(String url) {
        this(url, SourceInfoStorageFactory.newEmptySourceInfoStorage());
    }

    public HttpUrlSource_bat(String url, SourceInfoStorage sourceInfoStorage) {
        this(url, sourceInfoStorage, new EmptyHeadersInjector());
    }

    public HttpUrlSource_bat(String url, SourceInfoStorage sourceInfoStorage, HeaderInjector headerInjector) {
    ...
    public HttpUrlSource_bat(HttpUrlSource_bat source) {
