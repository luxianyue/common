...
public class AssetsDatabaseManager {
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        final int ver = 2;
        boolean flag = dbs.getBoolean(dbfile+ver, false); // Get Database file flag, if true means this database file was copied and valid
        if(!flag || !file.exists()){
            file = new File(spath);
            ...
            dbs.edit().putBoolean(dbfile+ver, true).commit();
        }
