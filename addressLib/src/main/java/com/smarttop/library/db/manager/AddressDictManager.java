...
import static com.smarttop.library.db.TableField.ADDRESS_DICT_FIELD_SID;
...
public class AddressDictManager {
    ...
    public void inserddress(AdressBean.ChangeRecordsBean adress){
        if(adress !=null){
            ...
            try{
                ...
                values.put(TableField.ADDRESS_DICT_FIELD_PARENTID,adress.pid);
                values.put(TableField.ADDRESS_DICT_FIELD_ID,adress.id);
                values.put(TableField.ADDRESS_DICT_FIELD_SID, adress.id);
        ...
        if(list !=null){
            ...
            try{
                for (AdressBean.ChangeRecordsBean adress:list) {
                    ...
                    values.put(ADDRESS_DICT_FIELD_CODE,adress.code);
                    values.put(TableField.ADDRESS_DICT_FIELD_NAME,adress.name);
                    values.put(ADDRESS_DICT_FIELD_PARENTID,adress.pid);
                    values.put(TableField.ADDRESS_DICT_FIELD_ID,adress.id);
                    db.insert(TableField.TABLE_ADDRESS_DICT,null,values);
                }
                db.setTransactionSuccessful(); //设置事务处理成功
    ...
    public List<AdressBean.ChangeRecordsBean> getAddressList(){
        ...
        while (cursor.moveToNext()){
            ...
            adressInfo.sid = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_SID));
            adressInfo.pid = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_PARENTID));
    ...
    public List<Province> getProvinceList(){
        ...
        while (cursor.moveToNext()){
            ...
            province.sid = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_SID));
    ...
    public List<City> getCityList(String  provinceId){
        ...
        while (cursor.moveToNext()){
            ...
            city.sid = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_SID));
     ...
     * @return
     */
    public List<County> getCountyList(String cityId){
        ...
        while (cursor.moveToNext()){
            ...
            county.sid = cursor.getString(cursor.getColumnIndex(ADDRESS_DICT_FIELD_SID));
     ...
     * @return
     */
    public List<Street> getStreetList(String countyId){
